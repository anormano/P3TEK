...
namespace P3TEK.Web {
    ...
    public partial class P3TEKAspNetApplication : WebApplication {
        private DevExpress.ExpressApp.SystemModule.SystemModule module1;
        private DevExpress.ExpressApp.Web.SystemModule.SystemAspNetModule module2;
        private P3TEK.Module.P3TEKModule module3;
        private P3TEK.Module.Web.P3TEKAspNetModule module4;
        ...
        private void P3TEKAspNetApplication_DatabaseVersionMismatch(object sender, DevExpress.ExpressApp.DatabaseVersionMismatchEventArgs e) {
#if EASYTEST
            e.Updater.Update();
            e.Handled = true;
#else
